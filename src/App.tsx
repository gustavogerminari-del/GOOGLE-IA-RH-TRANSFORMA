...
import { MigrationCenterView } from './migration';
          ...
          <ProtectedRoute screenKey={activeTab as any}>
            ...
            {activeTab === 'contratacoes' && (
              <UnifiedContratacoesView
                origemProcesso={isModuleActive('headhunter') && !isModuleActive('departamentoPessoal') ? 'headhunter' : 'recrutamento_interno'}
            ...
            {activeTab === 'implantacao-migracao' && <MigrationCenterView />}
